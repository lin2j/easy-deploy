...
public interface SshConnection {
    ...
    /**
     * execute command asynchronously, with real-time output to command log
     *
     * @param commandLog         command log for real-time output
     * @param cmd                command to execute
     * @param closeAfterFinished whether to close the connection after execution
     * @return a FutureTask that can be used to track the execution status
     */
    FutureTask<Void> executeAsync(CommandLog commandLog, String cmd, boolean closeAfterFinished);
